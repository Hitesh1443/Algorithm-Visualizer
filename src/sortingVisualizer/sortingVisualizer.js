      ...
      <div className={classes.Layout}>
        ...
        <div className={buttonClasses.join(" ")}>
          ...
          <div className={classes.Sorts}>
            <button disabled={disableButton} onClick={() => mergeSort()}>
              Merge Sort
            </button>
            <button disabled={disableButton} onClick={() => quickSort()}>
              Quick Sort
            </button>
            <button disabled={disableButton} onClick={() => heapSort()}>
              Heap Sort
            </button>
            <button disabled={disableButton} onClick={() => insertionSort()}>
              Insertion Sort
            </button>
          </div>
        </div>
